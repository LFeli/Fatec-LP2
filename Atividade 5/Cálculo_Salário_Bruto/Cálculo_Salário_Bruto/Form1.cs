...
namespace Cálculo_Salário_Bruto
{
    public partial class Form1 : Form
    {
        ...
        private void btnCalcu_Click(object sender, EventArgs e)
        {
            ...
            //Mensagem
            if (cmbSexo.SelectedIndex == 0 && cmbCasado.SelectedIndex == 0 )
                MessageBox.Show("O senhor " + txtNomeFunci.Text + " que e casado, e tem "+ txtNumFilhos.Text +" filhos(a) ja teve sua dashboard atualizada");
            if (cmbSexo.SelectedIndex == 0 && cmbCasado.SelectedIndex == 1)
                MessageBox.Show("O senhor " + txtNomeFunci.Text + " que e solteiro, e tem " + txtNumFilhos.Text + " filhos (a) ja teve sua dashboard atualizada");
            if (cmbSexo.SelectedIndex == 1 && cmbCasado.SelectedIndex == 0)
                MessageBox.Show("A senhora " + txtNomeFunci.Text +" que e casada e tem" + txtNumFilhos.Text +" filhos(a) ja teve sua dashboard atualizada");
            if (cmbSexo.SelectedIndex == 1 && cmbCasado.SelectedIndex == 1)
                MessageBox.Show("A senhora " + txtNomeFunci.Text + " que e solteira e tem" + txtNumFilhos.Text + " filhos(a) ja teve sua dashboard atualizada");
        }
